		...
		<div class='car_info_series_list'>
			<ul class='series_list'>
				<s:iterator value="vehicleList" status="id">
					<li emission_id='<s:property value="emission_code" />-<s:property value="series_code" />' emission_name='<s:property value="emission_code" />' class=''><s:property value="emission_code" /></li>
				</s:iterator>
