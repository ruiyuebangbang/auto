...
FancyUpload2.File = new Class({
	...
	render: function() {
		...
		this.element = new Element('li', {'style': 'width: 210px; height: 130px; float: left; margin: 10px; background-color: #f5f5f5; overflow: hidden;'}).adopt(
			new Element('div', {'class': 'file-c','style':'height:106px;', 'html':  MooTools.lang.get('FancyUpload', 'fileName').substitute(this)}),
			new Element('a', {
				'class': 'file-remove btn btn-small',
				href: '#',
